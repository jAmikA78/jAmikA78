...
<p align="center">
  I'm a software engineer from Egypt with a passion for problem-solving, competitive programming, and building creative solutions to complex challenges. I enjoy learning programming languages and frameworks, as well as implementing designs. Currently, I'm an instructor at MACPC.<br>
  I have experience in mobile applications with Flutter, desktop applications with Java, and full-stack web development with (HTML, CSS, JavaScript, PHP, and Bootstrap).<br>
  I have successfully competed as an ECPC finalist and continue to explore new challenges in the ever-evolving tech landscape.
</p>
